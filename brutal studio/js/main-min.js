//@prepros-append jquery3.3.1.js

//@prepros-append rellax.min.js

//@prepros-append preloader.js

//@prepros-append lazy-load.js

//@prepros-append mail.js

//@prepros-append smoothscroll.js

//@prepros-append backtotop.js

//@prepros-append smoothPageTransition.js

//@prepros-append wow.js

//@prepros-append progressbar.js
...
$(document).ready(function () {
	$("form").submit(function () { //Change
		...
		$.ajax({
			...
			alert("Ваша завявка успешно принята");
			setTimeout(function () {
				// Done Functions
				th.trigger("reset");
			}, 1000);
...
jQuery("html").on('click', '[href*="#"]', function (e) {
	var fixed_offset = 100;
	jQuery('html').stop().animate({ scrollTop: jQuery(this.hash).offset().top - fixed_offset }, 1000);
	e.preventDefault();
});
...
$(window).scroll(function () {
	...
	$(".progress-cont__prog").width(ratio + "%");
});
